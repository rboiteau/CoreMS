...
CoreMS run script for correlating ICPMS, ESIMS data
    ...
    Dataset:        iulia_iodine_test

    Instruments:    WHOI iCAP RQ, WHOI Fusion(?)

    Analysis notes: attempting to identify I features 
"""

def plotICPMS(icp_data_file = None, elements = ['127I'], offset = 0, ax = None):
...
if __name__ == '__main__':
    ...
    drive_dir = '/home/dewey/Rawfiles/iulia-iodine/'
    svdir=drive_dir
    
    mzref = "/home/dewey/CoreMS/db/Hawkes_neg.ref"
    ...
    esifile_name = 'Organics_mix_02.raw'
    data_dir = drive_dir
    esifile = data_dir+esifile_name
    esiparser = rawFileReader.ImportMassSpectraThermoMSFileReader(esifile)
    icpmsfile = data_dir + '230310_Organics_mix_iCap.csv'
    results_fname='230310_Organics_mix_iCap.csv'
