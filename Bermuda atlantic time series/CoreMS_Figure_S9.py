# Python script for generating Figure S9: Class graphs
...
sns.histplot(x='Heteroatom Class', data=clusteredlist[clusteredlist['N']==0], ax=axs['a'], hue='cluster', weights='Intensity', hue_order=hue_order, legend=False,multiple='dodge')
