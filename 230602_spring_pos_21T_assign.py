...
def setAssingmentParams():
    ...
    MSParameters.molecular_search.min_ppm_error = -0.35
    MSParameters.molecular_search.max_ppm_error = 0.35
...
if __name__ == '__main__':
    ...
    for f in f_raw:
        ...
        output1 = assign_formula(esifile = f, times = times, cal_ppm_threshold=(-1,1), refmasslist = mzref)
        output1['file'] = f 
