# Python script for generating mass formula assignments of LCMS Orbitrap data with CoreMS
# RMB  5/26/2023
...
allresults.to_csv(file_location+'/'+allresultsfile)
