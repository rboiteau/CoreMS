...
file="LN_20230324_Pooledmix3_35.raw" #pooled sample for formula assignments
refmasslist = file_location+"siloxanes3_pos.ref"

savefile='Cardon_pooled_assigned_results.csv'
...
MSParameters.mass_spectrum.min_calib_ppm_error = -20
MSParameters.mass_spectrum.max_calib_ppm_error = 20
MSParameters.mass_spectrum.calib_pol_order = 1
MSParameters.mass_spectrum.calib_sn_threshold = 10000
MSParameters.mass_spectrum.min_picking_mz=100
MSParameters.mass_spectrum.max_picking_mz=500
