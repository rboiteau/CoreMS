...
allresults=allresults[(allresults['m/z Error (ppm)']>-0.4) & (allresults['m/z Error (ppm)']<0.4)]

allresults.loc[allresults['N']>5,'Molecular class']='CHON>5'
...
results_1=results[(results['Molecular class'].isin(['CHO','CHON','CHONa']))]
results_2=results[(~results['Molecular class'].isin(['CHO','CHON','CHONa']))]
