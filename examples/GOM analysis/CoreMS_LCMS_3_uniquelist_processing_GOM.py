...
clusteredresults_file='GOMpooled_clustered_results.csv'
##### End user input



uniqueresults=pd.read_csv(file_location+uniqueresults_file)
...
results_clustered.to_csv(file_location+clusteredresults_file)
