...
def printRunTime():
    ...
    elapsed_time_sec_2 = start - time.time()

    if elapsed_time_sec_2 > 3600:
        elapsed_time_2 = elapsed_time_sec_2 / 3600
        unit = 'hr'
    else:
        elapsed_time_2 = elapsed_time_sec_2 / 60
        unit = 'min'
    ...
    print('Assignment took %.2f %s to complete' %(elapsed_time_2, unit))
...
if __name__ == '__main__':
    ...
    asgn_dir = '/Users/christiandewey/Library/CloudStorage/GoogleDrive-christian.w.dewey@gmail.com/My Drive/manuscripts/2023_Dewey-Boiteau-etal_mz-windowing/assignments/slough-env/'
    fname = '230216_slough-env_pos_21TNHMFL-Jan_001.csv'

    heter = ['N', 'Na', 'S', 'P', 'Fe', 'Cu']  # from 230215_wastewater-final-eff_neg_21T_assign.py
