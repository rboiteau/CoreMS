...
if __name__ == '__main__':
    ...
    offset = 7.4  # ICPMS time (s) + offset (s) = ESI time (s)  7.4   4.4

    esifile_name = 'LN_20230227_SE_RC_ENV1_NEG_17.raw' #'aLN_20230227_SE_RC_ENV1_NEG_17_20230301165835.raw'
    data_dir = drive_dir
    ...
    results_fname='LN_230301_SE_ENV1_003.csv'
